...
- **ObservableProperty**: Usare gli attributi `[ObservableProperty]` sui campi privati per generare automaticamente le proprietà notificabili tramite Source Generators.
...
- Lescansioni di Windows Update devono avvenire esclusivamente a seguito di un'azione esplicita dell'utente.
