...
- `0x8a150002` (`-1978335230`): Installer hash mismatch (`WINGET_ERROR_INSTALLER_HASH_MISMATCH` / requires `InstallerHashOverride` setting or `--ignore-security-hash`).
...
## 4. Integration Guidelines in C# / .NET 10
